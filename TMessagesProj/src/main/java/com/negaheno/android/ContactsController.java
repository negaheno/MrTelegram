...
import com.negaheno.messenger.BuildVars;
...
public class ContactsController {
    ...
    public String getInviteText() {
        return inviteText != null ? inviteText : LocaleController.getString("InviteText", com.negaheno.messenger.R.string.InviteText);
    }

    public void checkAppAccount() {
        AccountManager am = AccountManager.get(ApplicationLoader.applicationContext);
        Account[] accounts = am.getAccountsByType("com.negaheno.account");
        ...
        if (recreateAccount) {
            ...
            if (UserConfig.isClientActivated()) {
                try {
                    currentAccount = new Account(UserConfig.getCurrentUser().phone, "com.negaheno.account");
                ...
                if (pCur.getCount() > 0) {
                    while (pCur.moveToNext()) {
                        ...
                        if (type == ContactsContract.CommonDataKinds.Phone.TYPE_CUSTOM) {
                            ...
                            contact.phoneTypes.add(LocaleController.getString("PhoneHome", com.negaheno.messenger.R.string.PhoneHome));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_MOBILE) {
                            contact.phoneTypes.add(LocaleController.getString("PhoneMobile", com.negaheno.messenger.R.string.PhoneMobile));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_WORK) {
                            contact.phoneTypes.add(LocaleController.getString("PhoneWork", com.negaheno.messenger.R.string.PhoneWork));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_MAIN) {
                            contact.phoneTypes.add(LocaleController.getString("PhoneMain", com.negaheno.messenger.R.string.PhoneMain));
                        } else {
                            contact.phoneTypes.add(LocaleController.getString("PhoneOther", com.negaheno.messenger.R.string.PhoneOther));
                        }
...
//        query.add(builder.build());
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.negaheno.messenger.android.profile");
