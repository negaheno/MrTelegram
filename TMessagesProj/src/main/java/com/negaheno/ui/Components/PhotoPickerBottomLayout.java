...
public class PhotoPickerBottomLayout extends FrameLayout {
    ...
    public PhotoPickerBottomLayout(Context context) {
        ...
        cancelButton.setBackgroundResource(com.negaheno.messenger.R.drawable.bar_selector_picker);
        cancelButton.setPadding(AndroidUtilities.dp(29), 0, AndroidUtilities.dp(29), 0);
        cancelButton.setText(LocaleController.getString("Cancel", com.negaheno.messenger.R.string.Cancel).toUpperCase());
        ...
        doneButton.setBackgroundResource(com.negaheno.messenger.R.drawable.bar_selector_picker);
        ...
        doneButtonBadgeTextView.setBackgroundResource(com.negaheno.messenger.R.drawable.photobadge);
        ...
        doneButtonTextView.setText(LocaleController.getString("Send", com.negaheno.messenger.R.string.Send).toUpperCase());
