...
package com.negaheno.ui.ActionBar;
...
public class ActionBarMenuItem extends FrameLayoutFixed {
    ...
    public TextView addSubItem(int id, String text, int icon) {
        if (popupLayout == null) {
            ...
            popupLayout.setBackgroundResource(com.negaheno.messenger.R.drawable.popup_fixed);
        ...
        textView.setBackgroundResource(com.negaheno.messenger.R.drawable.list_selector);
    ...
    public void toggleSubMenu() {
        ...
        if (popupWindow == null) {
            ...
            popupWindow.setAnimationStyle(com.negaheno.messenger.R.style.PopupAnimation);
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        if (value && searchContainer == null) {
            ...
            try {
                ...
                mCursorDrawableRes.set(searchField, com.negaheno.messenger.R.drawable.search_carret);
            } catch (Exception e) {
                //nothing to do
            }
            ...
            clearButton.setImageResource(com.negaheno.messenger.R.drawable.ic_close_white);
