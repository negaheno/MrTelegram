...
import com.negaheno.ui.Cells.TextSettingsCell;
import com.negaheno.ui.Components.AvatarDrawable;
import com.negaheno.ui.Components.ColorSelectorDialog;
...
public class ThemingActivity extends BaseFragment {
    ...
    public View createView(LayoutInflater inflater) {
        if (fragmentView == null) {
            ...
            actionBar.setTitle(LocaleController.getString("Theming", com.negaheno.messenger.R.string.Theming));
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                    ...
                    if (i == themeColorRow) {
                        ...
                        view = li.inflate(com.negaheno.messenger.R.layout.colordialog, null, false);

                        ColorSelectorDialog colorDialog = new ColorSelectorDialog(getParentActivity(), new ColorSelectorDialog.OnColorChangedListener() {
                            @Override
                        ...
                        View promptsView = li.inflate(com.negaheno.messenger.R.layout.editbox_dialog, null);
                        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                        builder.setView(promptsView);
                        final EditText userInput = (EditText) promptsView.findViewById(com.negaheno.messenger.R.id.editTextDialogUserInput);
                        builder.setMessage(LocaleController.getString("EnterName", com.negaheno.messenger.R.string.EnterName));
                        ...
                        fragment.setDelegate(new DocumentSelectActivity.DocumentSelectActivityDelegate() {
                            ...
                            public void didSelectFiles(DocumentSelectActivity activity, ArrayList<String> files) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                                builder.setTitle(LocaleController.getString("ApplyTheme", com.negaheno.messenger.R.string.ApplyTheme));
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                        builder.setMessage(LocaleController.getString("AreYouSure", com.negaheno.messenger.R.string.AreYouSure));
                        builder.setTitle(LocaleController.getString("ResetThemeSettings", com.negaheno.messenger.R.string.ResetThemeSettings));
                        builder.setPositiveButton(LocaleController.getString("OK", com.negaheno.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if (reseting) {
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                fixLayout();
                                                if (getParentActivity() != null) {
                                                    Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("ResetThemeToastText", com.negaheno.messenger.R.string.ResetThemeToastText), Toast.LENGTH_SHORT);
                                                    toast.show();
                                                }
                                            }
                                });
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == generalSection2Row) {
                    ((HeaderCell) view).setText(LocaleController.getString("General", com.negaheno.messenger.R.string.General));
                } else if (i == screensSection2Row) {
                    ((HeaderCell) view).setText(LocaleController.getString("Screens", com.negaheno.messenger.R.string.Screens));
                } else if (i == themesSection2Row) {
                    ((HeaderCell) view).setText(LocaleController.getString("Themes", com.negaheno.messenger.R.string.Themes));
                }
            }
            else if (type == 2) {
                if (view == null) {
                ...
                if (i == chatsRow) {
                    textCell.setText(LocaleController.getString("MainScreen", com.negaheno.messenger.R.string.MainScreen), true);
                } else if (i == chatRow) {
                    textCell.setText(LocaleController.getString("ChatScreen", com.negaheno.messenger.R.string.ChatScreen), true);
                } else if (i == contactsRow) {
                    textCell.setText(LocaleController.getString("ContactsScreen", com.negaheno.messenger.R.string.ContactsScreen), true);
                }
                ...
                if (i == resetThemeRow) {
                    ...
                    textCell.setTextAndValue(LocaleController.getString("ResetThemeSettings", com.negaheno.messenger.R.string.ResetThemeSettings), LocaleController.getString("ResetThemeSettingsSum", com.negaheno.messenger.R.string.ResetThemeSettingsSum), false);
                } else if (i == saveThemeRow) {
                    textCell.setMultilineDetail(true);
                    textCell.setTextAndValue(LocaleController.getString("SaveTheme", com.negaheno.messenger.R.string.SaveTheme), LocaleController.getString("SaveThemeSum", com.negaheno.messenger.R.string.SaveThemeSum), false);
                }  else if (i == applyThemeRow) {
                    textCell.setMultilineDetail(true);
                    textCell.setTextAndValue(LocaleController.getString("ApplyTheme", com.negaheno.messenger.R.string.ApplyTheme), LocaleController.getString("ApplyThemeSum", com.negaheno.messenger.R.string.ApplyThemeSum), false);
                }
            }
            else if (type == 4){
                if (view == null) {
                ...
                if (i == themeColorRow) {
                    textCell.setTextAndColor(LocaleController.getString("themeColor", com.negaheno.messenger.R.string.themeColor), AndroidUtilities.getIntColor("themeColor"), true);
                }
            }
