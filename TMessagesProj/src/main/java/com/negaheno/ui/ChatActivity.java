...
import com.negaheno.PhoneFormat.PhoneFormat;
import com.negaheno.android.AndroidUtilities;
import com.negaheno.android.ImageReceiver;
import com.negaheno.android.LocaleController;
import com.negaheno.android.MediaController;
import com.negaheno.android.MessageObject;
...
import com.negaheno.android.NotificationsController;
import com.negaheno.android.SecretChatHelper;
import com.negaheno.android.SendMessagesHelper;
import com.negaheno.messenger.ApplicationLoader;
import com.negaheno.messenger.ConnectionsManager;
import com.negaheno.messenger.FileLoader;
import com.negaheno.messenger.FileLog;
import com.negaheno.messenger.TLRPC;
import com.negaheno.messenger.UserConfig;
import com.negaheno.messenger.Utilities;
...
import com.negaheno.ui.Adapters.BaseFragmentAdapter;
import com.negaheno.ui.Adapters.StickersAdapter;
import com.negaheno.ui.AnimationCompat.AnimatorListenerAdapterProxy;
import com.negaheno.ui.AnimationCompat.AnimatorSetProxy;
import com.negaheno.ui.AnimationCompat.ObjectAnimatorProxy;
import com.negaheno.ui.AnimationCompat.ViewProxy;
import com.negaheno.ui.Cells.ChatActionCell;
import com.negaheno.ui.Cells.ChatBaseCell;
import com.negaheno.ui.Cells.ChatMediaCell;
import com.negaheno.ui.Cells.ChatMessageCell;
import com.negaheno.ui.Components.AvatarDrawable;
import com.negaheno.ui.Components.BackupImageView;
import com.negaheno.ui.Components.FrameLayoutFixed;
import com.negaheno.ui.Components.LayoutListView;
import com.negaheno.ui.Components.RecyclerListView;
import com.negaheno.ui.Components.SizeNotifierRelativeLayout;
import com.negaheno.ui.Components.TimerDrawable;
import com.negaheno.ui.Components.TypingDotsDrawable;
import com.negaheno.android.ContactsController;
import com.negaheno.ui.ActionBar.ActionBarMenuItem;
import com.negaheno.ui.Cells.ChatAudioCell;
import com.negaheno.ui.Cells.ChatContactCell;
import com.negaheno.ui.Components.ChatActivityEnterView;
...
//PLUS
                        ...
                        builder.setMessage(LocaleController.formatString("AreYouSureDeleteMessages", com.negaheno.messenger.R.string.AreYouSureDeleteMessages, LocaleController.formatPluralString("messages", selectedMessagesIds.size())));
                        ...
                        args.putString("selectAlertString", LocaleController.getString("ForwardMessagesTo", com.negaheno.messenger.R.string.ForwardMessagesTo));
                        args.putString("selectAlertStringGroup", LocaleController.getString("ForwardMessagesToGroup", com.negaheno.messenger.R.string.ForwardMessagesToGroup));
                        ...
                        builder.setTitle(LocaleController.getString("AppName", com.negaheno.messenger.R.string.AppName));
                        if (id == clear_history) {
                            builder.setMessage(LocaleController.getString("AreYouSureClearHistory", com.negaheno.messenger.R.string.AreYouSureClearHistory));
                        } else {
                            if (isChat) {
                                builder.setMessage(LocaleController.getString("AreYouSureDeleteAndExit", com.negaheno.messenger.R.string.AreYouSureDeleteAndExit));
                            } else {
                                builder.setMessage(LocaleController.getString("AreYouSureDeleteThisChat", com.negaheno.messenger.R.string.AreYouSureDeleteThisChat));
                            }
                        }
                        builder.setPositiveButton(LocaleController.getString("OK", com.negaheno.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                            @Override
                        ...
                        if (currentUser.phone != null && currentUser.phone.length() != 0) {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                            builder.setMessage(LocaleController.getString("AreYouSureShareMyContactInfo", com.negaheno.messenger.R.string.AreYouSureShareMyContactInfo));
                            builder.setTitle(LocaleController.getString("AppName", com.negaheno.messenger.R.string.AppName));
                            builder.setPositiveButton(LocaleController.getString("OK", com.negaheno.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (!muted) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                            builder.setTitle(LocaleController.getString("Notifications", com.negaheno.messenger.R.string.Notifications));
                            CharSequence[] items = new CharSequence[]{
                                    LocaleController.formatString("MuteFor", com.negaheno.messenger.R.string.MuteFor, LocaleController.formatPluralString("Hours", 1)),
                                    LocaleController.formatString("MuteFor", com.negaheno.messenger.R.string.MuteFor, LocaleController.formatPluralString("Hours", 8)),
                                    LocaleController.formatString("MuteFor", com.negaheno.messenger.R.string.MuteFor, LocaleController.formatPluralString("Days", 2)),
                                    LocaleController.getString("MuteDisable", com.negaheno.messenger.R.string.MuteDisable)
                            };
            ...
            avatarContainer.setBackgroundResource(com.negaheno.messenger.R.drawable.bar_selector);
            ...
            headerItem = menu.addItem(0, com.negaheno.messenger.R.drawable.ic_ab_other);
            if (currentUser != null) {
                addContactItem = headerItem.addSubItem(share_contact, "", 0);
            }
            if (currentEncryptedChat != null) {
                timeItem2 = headerItem.addSubItem(chat_enc_timer, LocaleController.getString("SetTimer", com.negaheno.messenger.R.string.SetTimer), 0);
            }
            headerItem.addSubItem(clear_history, LocaleController.getString("ClearHistory", com.negaheno.messenger.R.string.ClearHistory), 0);
            if (currentChat != null && !isBroadcast) {
                headerItem.addSubItem(delete_chat, LocaleController.getString("DeleteAndExit", com.negaheno.messenger.R.string.DeleteAndExit), 0);
            } else {
                headerItem.addSubItem(delete_chat, LocaleController.getString("DeleteChatUser", com.negaheno.messenger.R.string.DeleteChatUser), 0);
            }
            ...
            attachItem = menu.addItem(chat_menu_attach, com.negaheno.messenger.R.drawable.ic_ab_other);
            attachItem.addSubItem(attach_photo, LocaleController.getString("ChatTakePhoto", com.negaheno.messenger.R.string.ChatTakePhoto), com.negaheno.messenger.R.drawable.ic_attach_photo);
            attachItem.addSubItem(attach_gallery, LocaleController.getString("ChatGallery", com.negaheno.messenger.R.string.ChatGallery), com.negaheno.messenger.R.drawable.ic_attach_gallery);
            attachItem.addSubItem(attach_music, LocaleController.getString("ChatMusic", com.negaheno.messenger.R.string.ChatMusic), com.negaheno.messenger.R.drawable.ic_attach_music);
            attachItem.addSubItem(attach_video, LocaleController.getString("ChatVideo", com.negaheno.messenger.R.string.ChatVideo), com.negaheno.messenger.R.drawable.ic_attach_video);
            attachItem.addSubItem(attach_document, LocaleController.getString("ChatDocument", com.negaheno.messenger.R.string.ChatDocument), com.negaheno.messenger.R.drawable.ic_ab_doc);
            attachItem.addSubItem(attach_location, LocaleController.getString("ChatLocation", com.negaheno.messenger.R.string.ChatLocation), com.negaheno.messenger.R.drawable.ic_attach_location);
            attachItem.setVisibility(View.INVISIBLE);

            menuItem = menu.addItem(chat_menu_attach, com.negaheno.messenger.R.drawable.ic_ab_attach);
            menuItem.addSubItem(attach_photo, LocaleController.getString("ChatTakePhoto", com.negaheno.messenger.R.string.ChatTakePhoto), com.negaheno.messenger.R.drawable.ic_attach_photo);
            menuItem.addSubItem(attach_gallery, LocaleController.getString("ChatGallery", com.negaheno.messenger.R.string.ChatGallery), com.negaheno.messenger.R.drawable.ic_attach_gallery);
            menuItem.addSubItem(attach_music, LocaleController.getString("ChatMusic", com.negaheno.messenger.R.string.ChatMusic), com.negaheno.messenger.R.drawable.ic_attach_music);
            menuItem.addSubItem(attach_video, LocaleController.getString("ChatVideo", com.negaheno.messenger.R.string.ChatVideo), com.negaheno.messenger.R.drawable.ic_attach_video);
            menuItem.addSubItem(attach_document, LocaleController.getString("ChatDocument", com.negaheno.messenger.R.string.ChatDocument), com.negaheno.messenger.R.drawable.ic_ab_doc);
            menuItem.addSubItem(attach_location, LocaleController.getString("ChatLocation", com.negaheno.messenger.R.string.ChatLocation), com.negaheno.messenger.R.drawable.ic_attach_location);
            ...
            actionModeViews.add(actionMode.addItem(-2, com.negaheno.messenger.R.drawable.ic_ab_back_grey, com.negaheno.messenger.R.drawable.bar_selector_mode, null, AndroidUtilities.dp(54)));
            ...
            if (currentEncryptedChat == null) {
                actionModeViews.add(actionMode.addItem(copy, com.negaheno.messenger.R.drawable.ic_ab_fwd_copy, com.negaheno.messenger.R.drawable.bar_selector_mode, null, AndroidUtilities.dp(54)));
                actionModeViews.add(actionMode.addItem(forward, com.negaheno.messenger.R.drawable.ic_ab_fwd_forward, com.negaheno.messenger.R.drawable.bar_selector_mode, null, AndroidUtilities.dp(54)));
                actionModeViews.add(actionMode.addItem(delete, com.negaheno.messenger.R.drawable.ic_ab_fwd_delete, com.negaheno.messenger.R.drawable.bar_selector_mode, null, AndroidUtilities.dp(54)));
            } else {
                actionModeViews.add(actionMode.addItem(copy, com.negaheno.messenger.R.drawable.ic_ab_fwd_copy, com.negaheno.messenger.R.drawable.bar_selector_mode, null, AndroidUtilities.dp(54)));
                actionModeViews.add(actionMode.addItem(delete, com.negaheno.messenger.R.drawable.ic_ab_fwd_delete, com.negaheno.messenger.R.drawable.bar_selector_mode, null, AndroidUtilities.dp(54)));
            }
            ...
            if (currentEncryptedChat == null) {
                ...
                if (currentUser != null && currentUser.id != 777000 && (currentUser.id / 1000 == 333 || currentUser.id % 1000 == 0)) {
                    emptyView.setText(LocaleController.getString("GotAQuestion", com.negaheno.messenger.R.string.GotAQuestion));
                } else {
            emptyView.setText(LocaleController.getString("NoMessages", com.negaheno.messenger.R.string.NoMessages));
            }
            emptyView.setPadding(AndroidUtilities.dp(7), AndroidUtilities.dp(1), AndroidUtilities.dp(7), AndroidUtilities.dp(1));
                ...
                emptyView.setBackgroundResource(isCustomTheme ? com.negaheno.messenger.R.drawable.system_black : com.negaheno.messenger.R.drawable.system_blue);
                ...
                secretChatPlaceholder.setBackgroundResource(isCustomTheme ? com.negaheno.messenger.R.drawable.system_black : com.negaheno.messenger.R.drawable.system_blue);
                ...
                if (currentEncryptedChat.admin_id == UserConfig.getClientUserId()) {
                    if (currentUser.first_name.length() > 0) {
                        secretViewStatusTextView.setText(LocaleController.formatString("EncryptedPlaceholderTitleOutgoing", com.negaheno.messenger.R.string.EncryptedPlaceholderTitleOutgoing, currentUser.first_name));
                    } else {
                        secretViewStatusTextView.setText(LocaleController.formatString("EncryptedPlaceholderTitleOutgoing", com.negaheno.messenger.R.string.EncryptedPlaceholderTitleOutgoing, currentUser.last_name));
                    }
                } else {
                    if (currentUser.first_name.length() > 0) {
                        secretViewStatusTextView.setText(LocaleController.formatString("EncryptedPlaceholderTitleIncoming", com.negaheno.messenger.R.string.EncryptedPlaceholderTitleIncoming, currentUser.first_name));
                    } else {
                        secretViewStatusTextView.setText(LocaleController.formatString("EncryptedPlaceholderTitleIncoming", com.negaheno.messenger.R.string.EncryptedPlaceholderTitleIncoming, currentUser.last_name));
                    }
                }
                ...
                textView.setText(LocaleController.getString("EncryptedDescriptionTitle", com.negaheno.messenger.R.string.EncryptedDescriptionTitle));
                ...
                for (int a = 0; a < 4; a++) {
                    ...
                    imageView.setImageResource(com.negaheno.messenger.R.drawable.ic_lock_white);
                    ...
                    switch (a) {
                        case 0:
                            textView.setText(LocaleController.getString("EncryptedDescription1", com.negaheno.messenger.R.string.EncryptedDescription1));
                            break;
                        case 1:
                            textView.setText(LocaleController.getString("EncryptedDescription2", com.negaheno.messenger.R.string.EncryptedDescription2));
                            break;
                        case 2:
                            textView.setText(LocaleController.getString("EncryptedDescription3", com.negaheno.messenger.R.string.EncryptedDescription3));
                            break;
                        case 3:
                            textView.setText(LocaleController.getString("EncryptedDescription4", com.negaheno.messenger.R.string.EncryptedDescription4));
                            break;
                    }
            ...
            chatListView.setSelector(com.negaheno.messenger.R.drawable.transparent);
                    ...
                    if (openSecretPhotoRunnable != null || SecretPhotoViewer.getInstance().isVisible()) {
                        if (event.getAction() == MotionEvent.ACTION_UP || event.getAction() == MotionEvent.ACTION_CANCEL || event.getAction() == MotionEvent.ACTION_POINTER_UP) {
                            ...
                            if (openSecretPhotoRunnable != null) {
                                ...
                                openSecretPhotoRunnable = null;
                                try {
                                    Toast.makeText(v.getContext(), LocaleController.getString("PhotoTip", com.negaheno.messenger.R.string.PhotoTip), Toast.LENGTH_SHORT).show();
                                } catch (Exception e) {
                                    FileLog.e("tmessages", e);
                                }
                            } else {
            ...
            progressView.setBackgroundResource(isCustomTheme ? com.negaheno.messenger.R.drawable.system_loader2 : com.negaheno.messenger.R.drawable.system_loader1);
            ...
            try {
            progressBar.setIndeterminateDrawable(getParentActivity().getResources().getDrawable(com.negaheno.messenger.R.drawable.loading_animation));
            } catch (Exception e) {
                //don't promt
            }
            ...
            ImageView imageView = new ImageView(getParentActivity());
            imageView.setImageResource(com.negaheno.messenger.R.drawable.stickers_back_arrow);
            ...
            bottomOverlayChat.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (currentUser != null && userBlocked) {
                        builder.setMessage(LocaleController.getString("AreYouSureUnblockContact", com.negaheno.messenger.R.string.AreYouSureUnblockContact));
                        builder.setPositiveButton(LocaleController.getString("OK", com.negaheno.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
            ...
            pagedownButton.setImageResource(com.negaheno.messenger.R.drawable.pagedown);
    ...
    private void updateSecretStatus() {
        ...
        if (currentEncryptedChat instanceof TLRPC.TL_encryptedChatRequested) {
            bottomOverlayText.setText(LocaleController.getString("EncryptionProcessing", com.negaheno.messenger.R.string.EncryptionProcessing));
            bottomOverlay.setVisibility(View.VISIBLE);
            hideKeyboard = true;
        } else if (currentEncryptedChat instanceof TLRPC.TL_encryptedChatWaiting) {
            bottomOverlayText.setText(Html.fromHtml(LocaleController.formatString("AwaitingEncryption", com.negaheno.messenger.R.string.AwaitingEncryption, "<b>" + currentUser.first_name + "</b>")));
            bottomOverlay.setVisibility(View.VISIBLE);
            hideKeyboard = true;
        } else if (currentEncryptedChat instanceof TLRPC.TL_encryptedChatDiscarded) {
            bottomOverlayText.setText(LocaleController.getString("EncryptionRejected", com.negaheno.messenger.R.string.EncryptionRejected));
            bottomOverlay.setVisibility(View.VISIBLE);
            chatActivityEnterView.setFieldText("");
            ...
            if (currentUser.id / 1000 != 777 && currentUser.id / 1000 != 333 && ContactsController.getInstance().contactsDict.get(currentUser.id) == null && (ContactsController.getInstance().contactsDict.size() != 0 || !ContactsController.getInstance().isLoadingContacts())) {
                if (currentUser.phone != null && currentUser.phone.length() != 0) {
                    ...
                    if (currentUser instanceof TLRPC.TL_userDeleted) {
                        nameTextView.setText(LocaleController.getString("HiddenName", com.negaheno.messenger.R.string.HiddenName));
                    } else {
    ...
    private void updateTitleIcons() {
        int leftIcon = currentEncryptedChat != null ? com.negaheno.messenger.R.drawable.ic_lock_header : 0;
        int rightIcon = MessagesController.getInstance().isDialogMuted(dialog_id) ? com.negaheno.messenger.R.drawable.mute_fixed : 0;
        nameTextView.setCompoundDrawablesWithIntrinsicBounds(leftIcon, 0, rightIcon, 0);

        if (rightIcon != 0) {
            muteItem.setText(LocaleController.getString("UnmuteNotifications", com.negaheno.messenger.R.string.UnmuteNotifications));
        } else {
            muteItem.setText(LocaleController.getString("MuteNotifications", com.negaheno.messenger.R.string.MuteNotifications));
        }
    }
        ...
        if (printString == null || printString.length() == 0) {
            ...
            if (currentChat != null) {
                if (currentChat instanceof TLRPC.TL_chatForbidden) {
                    onlineTextView.setText(LocaleController.getString("YouWereKicked", com.negaheno.messenger.R.string.YouWereKicked));
                } else if (currentChat.left) {
                    onlineTextView.setText(LocaleController.getString("YouLeft", com.negaheno.messenger.R.string.YouLeft));
                } else {
                    int count = currentChat.participants_count;
                    if (info != null) {
                        count = info.participants.size();
                ...
                if (currentUser.id == 333000 || currentUser.id == 777000) {
                    newStatus = LocaleController.getString("ServiceNotifications", com.negaheno.messenger.R.string.ServiceNotifications);
                }
    ...
    private void showAttachmentError() {
        ...
        Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("UnsupportedAttachment", com.negaheno.messenger.R.string.UnsupportedAttachment), Toast.LENGTH_SHORT);
        toast.show();
    }
                ...
                if (currentEncryptedChat != null && arr.size() == 1) {
                    ...
                    if (currentEncryptedChat != null && obj.isOut() && obj.messageOwner.action != null && obj.messageOwner.action instanceof TLRPC.TL_messageEncryptedAction &&
                        ...
                        if (AndroidUtilities.getPeerLayerVersion(currentEncryptedChat.layer) < 17 && currentEncryptedChat.ttl > 0 && currentEncryptedChat.ttl <= 60) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                            builder.setTitle(LocaleController.getString("AppName", com.negaheno.messenger.R.string.AppName));
                            builder.setPositiveButton(com.negaheno.messenger.R.string.OK, null);
                            builder.setMessage(LocaleController.formatString("CompatibilityChat", com.negaheno.messenger.R.string.CompatibilityChat, currentUser.first_name, currentUser.first_name));
                            showAlertDialog(builder);
                        }
                    }
                }
    ...
    private void updateBottomOverlay() {
        if (currentUser == null) {
            bottomOverlayChatText.setText(LocaleController.getString("DeleteThisGroup", com.negaheno.messenger.R.string.DeleteThisGroup));
        } else {
            if (userBlocked) {
                bottomOverlayChatText.setText(LocaleController.getString("Unblock", com.negaheno.messenger.R.string.Unblock));
            } else {
                bottomOverlayChatText.setText(LocaleController.getString("DeleteThisChat", com.negaheno.messenger.R.string.DeleteThisChat));
            }
        }
    ...
    private void updateContactStatus() {
        ...
        if (currentUser == null) {
            ...
            if (currentEncryptedChat != null && !(currentEncryptedChat instanceof TLRPC.TL_encryptedChat)
                ...
                if (currentUser.phone != null && currentUser.phone.length() != 0) {
                    addContactItem.setText(LocaleController.getString("AddToContacts", com.negaheno.messenger.R.string.AddToContacts));
                } else {
                    addContactItem.setText(LocaleController.getString("ShareMyContactInfo", com.negaheno.messenger.R.string.ShareMyContactInfo));
                }
            }
        }
    }
                ...
                public boolean onPreDraw() {
                    ...
                    if (AndroidUtilities.isTablet()) {
                        if (AndroidUtilities.isSmallTablet() && getParentActivity().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                            ...
                            actionBar.setBackButtonImage(com.negaheno.messenger.R.drawable.ic_close_white);
                        }
                    }
    ...
    public void createMenu(View v, boolean single) {
        ...
        if (single || type < 2 || type == 7) {
            if (type >= 0) {
                ...
                if (type == 0) {
                    items = new CharSequence[] {LocaleController.getString("Retry", com.negaheno.messenger.R.string.Retry), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                } else if (type == 1) {
                    items = new CharSequence[] {LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                } else if (type == 7) {
                    items = new CharSequence[] {LocaleController.getString("Retry", com.negaheno.messenger.R.string.Retry), LocaleController.getString("Copy", com.negaheno.messenger.R.string.Copy), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                } else {
                    if (currentEncryptedChat == null) {
                        if (type == 2) {
                            items = new CharSequence[]{LocaleController.getString("Forward", com.negaheno.messenger.R.string.Forward), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                        } else if (type == 3) {
                            items = new CharSequence[]{LocaleController.getString("Forward", com.negaheno.messenger.R.string.Forward), LocaleController.getString("Copy", com.negaheno.messenger.R.string.Copy), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                        } else if (type == 4) {
                            items = new CharSequence[]{LocaleController.getString(selectedObject.messageOwner.media instanceof TLRPC.TL_messageMediaDocument ? "ShareFile" : "SaveToGallery",
                                    selectedObject.messageOwner.media instanceof TLRPC.TL_messageMediaDocument ? com.negaheno.messenger.R.string.ShareFile : com.negaheno.messenger.R.string.SaveToGallery), LocaleController.getString("Forward", com.negaheno.messenger.R.string.Forward), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                        } else if (type == 5) {
                            items = new CharSequence[]{LocaleController.getString("ApplyLocalizationFile", com.negaheno.messenger.R.string.ApplyLocalizationFile), LocaleController.getString("ShareFile", com.negaheno.messenger.R.string.ShareFile), LocaleController.getString("Forward", com.negaheno.messenger.R.string.Forward), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                        } else if (type == 6) {
                            items = new CharSequence[]{LocaleController.getString("SaveToGallery", com.negaheno.messenger.R.string.SaveToGallery), LocaleController.getString("ShareFile", com.negaheno.messenger.R.string.ShareFile), LocaleController.getString("Forward", com.negaheno.messenger.R.string.Forward), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                        }
                    } else {
                        if (type == 2) {
                            items = new CharSequence[]{LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                        } else if (type == 3) {
                            items = new CharSequence[]{LocaleController.getString("Copy", com.negaheno.messenger.R.string.Copy), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                        } else if (type == 4) {
                            items = new CharSequence[]{LocaleController.getString(selectedObject.messageOwner.media instanceof TLRPC.TL_messageMediaDocument ? "ShareFile" : "SaveToGallery",
                                    selectedObject.messageOwner.media instanceof TLRPC.TL_messageMediaDocument ? com.negaheno.messenger.R.string.ShareFile : com.negaheno.messenger.R.string.SaveToGallery), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                        } else if (type == 5) {
                            items = new CharSequence[]{LocaleController.getString("ApplyLocalizationFile", com.negaheno.messenger.R.string.ApplyLocalizationFile), LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete)};
                        }
                    }
                }
                ...
                builder.setTitle(LocaleController.getString("Message", com.negaheno.messenger.R.string.Message));
                showAlertDialog(builder);
            }
            return;
        }
    ...
    private void processSelectedOption(int option) {
        ...
        if (option == 0) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setMessage(LocaleController.formatString("AreYouSureDeleteMessages", com.negaheno.messenger.R.string.AreYouSureDeleteMessages, LocaleController.formatPluralString("messages", 1)));
            builder.setTitle(LocaleController.getString("AppName", com.negaheno.messenger.R.string.AppName));
            builder.setPositiveButton(LocaleController.getString("OK", com.negaheno.messenger.R.string.OK), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (selectedObject.type == 3) {
                ...
                getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("ShareFile", com.negaheno.messenger.R.string.ShareFile)), 500);
            }
        } else if (option == 5) {
            File locFile = null;
            ...
            if (locFile != null) {
                if (LocaleController.getInstance().applyLanguageFile(locFile)) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setTitle(LocaleController.getString("AppName", com.negaheno.messenger.R.string.AppName));
                    builder.setMessage(LocaleController.getString("IncorrectLocalization", com.negaheno.messenger.R.string.IncorrectLocalization));
                    builder.setPositiveButton(LocaleController.getString("OK", com.negaheno.messenger.R.string.OK), null);
                    showAlertDialog(builder);
                }
            }
    ...
    private void alertUserOpenError(MessageObject message) {
        ...
        builder.setPositiveButton(LocaleController.getString("OK", com.negaheno.messenger.R.string.OK), null);
        if (message.type == 3) {
            builder.setMessage(LocaleController.getString("NoPlayerInstalled", com.negaheno.messenger.R.string.NoPlayerInstalled));
        } else {
            builder.setMessage(LocaleController.formatString("NoHandleAppInstalled", com.negaheno.messenger.R.string.NoHandleAppInstalled, message.messageOwner.media.document.mime_type));
        }
        showAlertDialog(builder);
    }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if ((!endReached || !forward_end_reached) && messages.size() != 0) {
                ...
                if (i == 0 && !endReached || !forward_end_reached && i == (messages.size() + 1 - offset)) {
                    ...
                    if (view == null) {
                        ...
                        view = li.inflate(com.negaheno.messenger.R.layout.chat_loading_layout, viewGroup, false);
                        progressBar = view.findViewById(com.negaheno.messenger.R.id.progressLayout);
                        if (isCustomTheme) {
                            progressBar.setBackgroundResource(com.negaheno.messenger.R.drawable.system_loader2);
                        } else {
                            progressBar.setBackgroundResource(com.negaheno.messenger.R.drawable.system_loader1);
                        }
                    } else {
                        progressBar = view.findViewById(com.negaheno.messenger.R.id.progressLayout);
                    }
            ...
            if (view == null) {
                if (type == 0) {
                    ...
                    LayoutInflater li = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    view = li.inflate(com.negaheno.messenger.R.layout.chat_unread_layout, viewGroup, false);
                } else if (type == 4) {
                    ...
                    if (view instanceof ChatMediaCell) {
                        ...
                        ((ChatContactCell)view).setContactDelegate(new ChatContactCell.ChatContactCellDelegate() {
                            ...
                            public void didClickPhone(ChatContactCell cell) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                                builder.setItems(new CharSequence[]{LocaleController.getString("Copy", com.negaheno.messenger.R.string.Copy), LocaleController.getString("Call", com.negaheno.messenger.R.string.Call)}, new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                if (i == 1) {
                                                    try {
            ...
            if (type == 6) {
                TextView messageTextView = (TextView)view.findViewById(com.negaheno.messenger.R.id.chat_message_text);
