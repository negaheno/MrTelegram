...
public class LanguageSelectActivity extends BaseFragment {
    ...
    public View createView(LayoutInflater inflater) {
        if (fragmentView == null) {
            ...
            actionBar.setTitle(LocaleController.getString("Language", com.negaheno.messenger.R.string.Language));
            ...
            listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    builder.setMessage(LocaleController.getString("DeleteLocalization", com.negaheno.messenger.R.string.DeleteLocalization));
                    builder.setTitle(LocaleController.getString("AppName", com.negaheno.messenger.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("Delete", com.negaheno.messenger.R.string.Delete), new DialogInterface.OnClickListener() {
                        @Override
