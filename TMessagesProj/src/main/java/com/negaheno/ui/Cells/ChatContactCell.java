...
public class ChatContactCell extends ChatBaseCell {
    ...
    public ChatContactCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            addContactDrawableIn = getResources().getDrawable(com.negaheno.messenger.R.drawable.addcontact_blue);
            addContactDrawableOut = getResources().getDrawable(com.negaheno.messenger.R.drawable.addcontact_green);
        }
    ...
    public void setMessageObject(MessageObject messageObject) {
        if (currentMessageObject != messageObject || isUserDataChanged()) {
            ...
            if (phone != null && phone.length() != 0) {
                ...
                phone = LocaleController.getString("NumberUnknown", com.negaheno.messenger.R.string.NumberUnknown);
            }
