...
import com.negaheno.android.ImageLoader;
...
import com.negaheno.ui.Components.ProgressView;
import com.negaheno.ui.Components.SeekBar;
...
public class ChatAudioCell extends ChatBaseCell implements SeekBar.SeekBarDelegate, MediaController.FileDownloadProgressListener {
    ...
    public ChatAudioCell(Context context) {
        ...
        if (timePaint == null) {
            statesDrawable[0][0] = getResources().getDrawable(com.negaheno.messenger.R.drawable.play1);
            statesDrawable[0][1] = getResources().getDrawable(com.negaheno.messenger.R.drawable.play1_pressed);
            statesDrawable[1][0] = getResources().getDrawable(com.negaheno.messenger.R.drawable.pause1);
            statesDrawable[1][1] = getResources().getDrawable(com.negaheno.messenger.R.drawable.pause1_pressed);
            statesDrawable[2][0] = getResources().getDrawable(com.negaheno.messenger.R.drawable.audioload1);
            statesDrawable[2][1] = getResources().getDrawable(com.negaheno.messenger.R.drawable.audioload1_pressed);
            statesDrawable[3][0] = getResources().getDrawable(com.negaheno.messenger.R.drawable.audiocancel1);
            statesDrawable[3][1] = getResources().getDrawable(com.negaheno.messenger.R.drawable.audiocancel1_pressed);

            statesDrawable[4][0] = getResources().getDrawable(com.negaheno.messenger.R.drawable.play2);
            statesDrawable[4][1] = getResources().getDrawable(com.negaheno.messenger.R.drawable.play2_pressed);
            statesDrawable[5][0] = getResources().getDrawable(com.negaheno.messenger.R.drawable.pause2);
            statesDrawable[5][1] = getResources().getDrawable(com.negaheno.messenger.R.drawable.pause2_pressed);
            statesDrawable[6][0] = getResources().getDrawable(com.negaheno.messenger.R.drawable.audioload2);
            statesDrawable[6][1] = getResources().getDrawable(com.negaheno.messenger.R.drawable.audioload2_pressed);
            statesDrawable[7][0] = getResources().getDrawable(com.negaheno.messenger.R.drawable.audiocancel2);
            statesDrawable[7][1] = getResources().getDrawable(com.negaheno.messenger.R.drawable.audiocancel2_pressed);
